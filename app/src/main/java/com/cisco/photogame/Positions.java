...
public class Positions {
    ...
    public static List<Dude> getDudes() {
        ...
        int defaultSoundGuy = R.raw.mweeljoh;
        int defaultSoundGirl = R.raw.lbergers;
        ...
        piecePositions.add(new Dude(R.drawable.dude_29, defaultSoundGuy, "John", new Point(929, 558)));
        ...
        piecePositions.add(new Dude(R.drawable.dude_9, defaultSoundGuy, "Jens Petter", new Point(966, 826)));
        ...
        piecePositions.add(new Dude(R.drawable.dude_22, defaultSoundGuy, "Indrajit", new Point(701, 329)));
        ...
        piecePositions.add(new Dude(R.drawable.dude_27, R.raw.nlovhaug, "Norma", new Point(1360, 571)));
        piecePositions.add(new Dude(R.drawable.dude_28, defaultSoundGirl, "Kirti", new Point(1170, 490)));
        ...
        piecePositions.add(new Dude(R.drawable.dude_32, defaultSoundGuy, "Bharat", new Point(227, 501)));
